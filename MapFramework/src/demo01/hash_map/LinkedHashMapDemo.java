...
public class LinkedHashMapDemo {
	...
	public static void main(String[] args) {
		...
		LinkedHashMap<Integer,String> batch1 = new LinkedHashMap<Integer,String>();
		batch1.put(101,"raj");
		batch1.put(102,"kiran");
		batch1.put(103,"pavan");
		System.out.println(batch1);
		
		LinkedHashMap<Integer,String> batch2 = new LinkedHashMap<Integer,String>();
		batch2.put(104,"madu");
		batch2.put(105,"prachi");
		batch2.put(106,"kirthi");
		System.out.println(batch2);
		
		LinkedHashMap<Integer,String> batch3 = new LinkedHashMap<Integer,String>(batch1);
		batch3.putAll(batch3);
		
		batch3.put(105,"maduri");
		System.out.println(batch3);
		
		// duplicates values are allowed in Linkedlist too
